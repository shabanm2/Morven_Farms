...
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Airtemp.diurnal.summer.png",width=800,height=400)
...
Airtemp.hourly.means<-Airtemp%>%
  ...
  mutate(Hour=format(as.POSIXct(Date),format="%H:%M"))%>%
...
Airtemp.hourly.means<-Airtemp.hourly.means%>%pivot_longer(cols=c("B.airtemp","C.airtemp","D.airtemp","D.airtemp","E.airtemp","F.airtemp","G.airtemp","N.airtemp"),names_to="Sensor",values_to="value")

Airtemp.hourly.sd<-Airtemp.hourly.sd%>%pivot_longer(cols=c("B.airtemp","C.airtemp","D.airtemp","D.airtemp","E.airtemp","F.airtemp","G.airtemp","N.airtemp"),names_to="Sensor",values_to="value")

ggplot(data=Airtemp.hourly.sd)+
  geom_point(aes(x=Hour,y=value,color=Sensor))+
  geom_line(aes(x=Hour,y=value,color=Sensor,group=Sensor))+
...
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Radiation.diurnal.summer.png",width=800,height=400)
...
Radiation.hourly.sd<-Radiation%>%
  ...
  mutate(Hour=format(as.POSIXct(Date),format="%H:%M"))%>%
  group_by(Hour) %>%
  mutate(SD = sd(na.omit(unlist(select(cur_data(), 2:6)))))%>% # change columns selected
  mutate(Mean= mean(na.omit(unlist(select(cur_data(), 2:6)))))%>%
  summarise_if(is.numeric, mean)

# remove A and C
Radiation.hourly.means<-Radiation.hourly.means%>%pivot_longer(cols=c("B.rad","E.rad","F.rad","G.rad","N.rad"),names_to="Sensor",values_to="value")

Radiation.hourly.sd<-Radiation.hourly.sd%>%pivot_longer(cols=c("B.rad","E.rad","F.rad","G.rad","N.rad"),names_to="Sensor",values_to="value")

ggplot(data=Radiation.hourly.sd)+
  geom_point(aes(x=Hour,y=value,color=Sensor))+
  geom_line(aes(x=Hour,y=value,color=Sensor,group=Sensor))+
  labs(title="ARC 1 Mean Hourly Solar Radiation (W/m^2) June 1 - Aug 31, 2022",x="24 Hour Cycle",y="Solar Radiation (W/m^2)")+
  theme(axis.text.x = element_text(angle = 30, hjust = 0.8))+
...
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Airtemp.diurnal.jun17_14.png",width=800,height=400)
...
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Radiation.diurnal.jun17_14.png",width=800,height=400)
...
fall2022<-read.csv("fall2022.csv")
...
converting all variables to numeric and removing commas from radiation vectors
```{r}
fall2022$Date<-as.POSIXct(fall2022$Date,format="%m/%d/%Y %H:%M",tz="UTC")
...
### Air temp by hour over a week
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Airtemp.diurnal.fall.png",width=800,height=400)
...
ggplot(data=Airtemp.hourly.sd)+
  geom_point(aes(x=Hour,y=value,color=Sensor))+
  geom_line(aes(x=Hour,y=value,color=Sensor,group=Sensor))+
  labs(title="ARC 1 Mean Hourly Air Temperature (F) Sept 1 - Nov 30, 2022",x="24 Hour Cycle",y="Air Temperature (deg F)")+
  theme(axis.text.x = element_text(angle = 30, hjust = 0.8))+
  scale_color_manual(values = c ("B.airtemp"="gold1","C.airtemp"="red","D.airtemp"="darkorchid3","E.airtemp"="navy","F.airtemp"="maroon","G.airtemp"="limegreen","N.airtemp"="darkgreen"))+
  theme1
dev.off()
...
### Radiation by hour over a week
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Radiation.diurnal.fall.png",width=800,height=400)
...
ggplot(data=Radiation.hourly.sd)+
  geom_point(aes(x=Hour,y=value,color=Sensor))+
  geom_line(aes(x=Hour,y=value,color=Sensor,group=Sensor))+
  labs(title="ARC 1 Mean Hourly Solar Radiation (W/m^2) Sept 1 - Nov 30, 2022",x="24 Hour Cycle",y="Solar Radiation (W/m^2)")+
  theme(axis.text.x = element_text(angle = 30, hjust = 0.8))+
  scale_color_manual(values = c ("B.rad"="gold1","C.rad"="red","D.rad"="darkorchid3","E.rad"="navy","F.rad"="maroon","G.rad"="limegreen","N.rad"="darkgreen"))+
  theme1
dev.off()
...
### Air temp by hour over a week - oct 17-24
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Airtemp.diurnal.oct17_24.png",width=800,height=400)
...
ggplot(data=Airtemp.hourly.sd)+
  geom_point(aes(x=Hour,y=value,color=Sensor))+
  geom_line(aes(x=Hour,y=value,color=Sensor,group=Sensor))+
  labs(title="ARC 1 Mean Hourly Air Temperature (F) Oct 17-24, 2022",x="24 Hour Cycle",y="Air Temperature (deg F)")+
  theme(axis.text.x = element_text(angle = 30, hjust = 0.8))+
  scale_color_manual(values = c ("B.airtemp"="gold1","C.airtemp"="red","D.airtemp"="darkorchid3","E.airtemp"="navy","F.airtemp"="maroon","G.airtemp"="limegreen","N.airtemp"="darkgreen"))+
  theme1
dev.off()
...
### Radiation by hour over a week - oct 17-24 
```{r fig1, fig.height=8, fig.width=20}
png("C:/Users/julia/OneDrive/Documents/Morven/Summer 2022/Diurnal Plots/Radiation.diurnal.oct17_24.png",width=800,height=400)
...
ggplot(data=Radiation.hourly.sd)+
  geom_point(aes(x=Hour,y=value,color=Sensor))+
  geom_line(aes(x=Hour,y=value,color=Sensor,group=Sensor))+
  labs(title="ARC 1 Mean Hourly Solar Radiation (W/m^2) Oct 17-24, 2022",x="24 Hour Cycle",y="Solar Radiation (W/m^2)")+
  theme(axis.text.x = element_text(angle = 30, hjust = 0.8))+
  scale_color_manual(values = c ("B.rad"="gold1","C.rad"="red","D.rad"="darkorchid3","E.rad"="navy","F.rad"="maroon","G.rad"="limegreen","N.rad"="darkgreen"))+
  theme1
dev.off()
